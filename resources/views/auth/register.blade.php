            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" id="registerForm">
                        ...
                        <div class="form-group row">
                            <label for="idnumber" class="col-md-4 col-form-label text-md-right">idnumber</label>
                        ...
                        <div class="form-group row">
                            <label for="hidnumber" class="col-md-4 col-form-label text-md-right">hidnumber</label>
                        ...
                        <div class="form-group row">
                            <label for="idphoto" class="col-md-4 col-form-label text-md-right">idphoto</label>
                        ...
                        <div class="form-group row">
                            <label for="healthidphoto" class="col-md-4 col-form-label text-md-right">healthidphoto</label>
